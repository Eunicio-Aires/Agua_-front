    ...
    <tfoot>
      <tr>
        ...
        <th></th> 
            ...
            {/* <ul>
                {faturasPagas.map((fatura:any)=>(
                    <li key={fatura._id} className="bg-gray-50 hover:bg-gray-100 rounded-lg my-3 p-2 flex items-center cursor-pointer">
