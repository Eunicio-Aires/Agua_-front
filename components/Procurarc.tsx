      ...
      return (
        ...
        {/* <div className="flex flex-col items-center justify-center
         space-y-6 text-center"> */}
            ...
            <form onSubmit={handleSubmit} className=" max-w-md flex-col  space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3"><input type="text" required className="w-full rounded-md border bg-gray-50 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50" placeholder="Codigo do cliente" id="codigo"name="codigo"  />
