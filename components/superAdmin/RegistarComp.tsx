...
export default function NewComp() {
  ...
  const handleSubmi = async (event: SyntheticEvent) => {
    ...
    const endpoint = `https://agua-front.vercel.app/api/newCompane/`
  ...
  <div className="-mx-3 md:flex mb-6">
    ...
    {/* <div className="md:w-1/2 px-3">
      ...
      <input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4" type="text" id="email" name="email" placeholder='Email'/>
    </div> */}
  </div>
